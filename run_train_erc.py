...
def get_IEMOCAP_loaders(data_path=None, batch_size=32, valid_rate=0.1, num_workers=0, pin_memory=True):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--graph_type', default='relation', help='relation/GCN3/DeepGCN/GF/GF2/GDF')
    ...
    parser.add_argument('--use_topic', action='store_true', default=True, help='whether to use topic information')

    parser.add_argument('--use_residue', action='store_true', default=True, help='whether to use residue information or not')

    parser.add_argument('--av_using_lstm', action='store_true', default=True, help='whether to use lstm in acoustic and visual modality')
    ...
    parser.add_argument('--batch-size', type=int, default=31, metavar='BS', help='batch size')
    ...
    modals = args.modals
    feat2dim = {'IS10': 1582, '3DCNN': 512, 'textCNN': 100, 'bert': 768, 'denseface': 342, 'MELD_text': 600, 'MELD_audio': 300,'test':200}
    D_audio = feat2dim['textCNN'] if args.dataset == 'IEMOCAP' else feat2dim['MELD_audio']
